...
public class UserController {
    ...
    public String findAllUser(Model model, @RequestParam(required = false,defaultValue = "1")Integer page,
        ...
        System.out.println(page+"="+maxpage+"=="+allUser);
        return "user";
    }
    ...
    //根据id查询用户信息
    @ResponseBody
    @ApiOperation("根据id查询用户信息,前台调用")
    @RequestMapping(value = "/ChaUser",method = RequestMethod.POST)
    public QueryResponseResult ChaUser(int id) {
        QueryResponseResult queryResponseResult = userService.ChaUser(id);
        return queryResponseResult;
    }
}